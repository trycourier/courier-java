...
@JsonDeserialize(builder = NotificationDraftUpdateVariationsParams.Builder.class)
public final class NotificationDraftUpdateVariationsParams {
    ...
    private NotificationDraftUpdateVariationsParams(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NotificationDraftUpdateVariationsParams
                && equalTo((NotificationDraftUpdateVariationsParams) other);
    }
    ...
    private boolean equalTo(NotificationDraftUpdateVariationsParams other) {
    ...
    public static final class Builder {
        ...
        public Builder from(NotificationDraftUpdateVariationsParams other) {
        ...
        public NotificationDraftUpdateVariationsParams build() {
            return new NotificationDraftUpdateVariationsParams(blocks, channels, additionalProperties);
        }
    }
}
