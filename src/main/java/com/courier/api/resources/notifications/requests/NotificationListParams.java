...
public final class NotificationListParams {
    ...
    private NotificationListParams(Optional<String> cursor, Map<String, Object> additionalProperties) {
        this.cursor = cursor;
    ...
    public static final class Builder {
        ...
        public NotificationListParams build() {
            return new NotificationListParams(cursor, additionalProperties);
        }
    }
}
