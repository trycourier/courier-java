...
public final class InboundBulkMessageV1 implements IInboundBulkMessageV1 {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InboundBulkMessageV1 && equalTo((InboundBulkMessageV1) other);
    }
    ...
    private boolean equalTo(InboundBulkMessageV1 other) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.brand, this.data, this.event, this.locale, this.override);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(InboundBulkMessageV1 other) {
        ...
        public InboundBulkMessageV1 build() {
            return new InboundBulkMessageV1(brand, data, event, locale, override, additionalProperties);
        }
    }
}
