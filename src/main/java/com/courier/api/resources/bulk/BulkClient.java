...
public class BulkClient {
    ...
    public BulkCreateJobResponse createJob(BulkCreateJobParams request, RequestOptions requestOptions) {
     ...
     */
    public void ingestUsers(String jobId, BulkIngestUsersParams request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("bulk")
     ...
     * Run a bulk job
     */
    public void runJob(String jobId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("bulk")
                .addPathSegment(jobId)
