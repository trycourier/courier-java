...
public class AsyncRawAutomationsClient {
     ...
     */
    public CompletableFuture<CourierHttpResponse<AutomationInvokeResponse>> invokeAutomationTemplate(
            String templateId) {
    ...
    public CompletableFuture<CourierHttpResponse<AutomationInvokeResponse>> invokeAutomationTemplate(
        ...
        CompletableFuture<CourierHttpResponse<AutomationInvokeResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new CourierHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), AutomationInvokeResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<CourierHttpResponse<AutomationInvokeResponse>> invokeAdHocAutomation(
