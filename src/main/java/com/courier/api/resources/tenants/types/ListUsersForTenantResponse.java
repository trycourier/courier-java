...
public final class ListUsersForTenantResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUsersForTenantResponse && equalTo((ListUsersForTenantResponse) other);
    }
    ...
    private boolean equalTo(ListUsersForTenantResponse other) {
    ...
    public interface HasMoreStage {
        ...
        Builder from(ListUsersForTenantResponse other);
    }
    ...
    public static final class Builder implements HasMoreStage, UrlStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListUsersForTenantResponse other) {
        ...
        public ListUsersForTenantResponse build() {
            return new ListUsersForTenantResponse(items, hasMore, url, nextUrl, cursor, additionalProperties);
        }
    }
}
