...
public final class BaseTemplateTenantAssociation implements IBaseTemplateTenantAssociation {
    ...
    private BaseTemplateTenantAssociation(
            String id,
            String createdAt,
            String updatedAt,
            String publishedAt,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BaseTemplateTenantAssociation && equalTo((BaseTemplateTenantAssociation) other);
    }
    ...
    private boolean equalTo(BaseTemplateTenantAssociation other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.id, this.createdAt, this.updatedAt, this.publishedAt, this.version);
    }
    ...
    public interface _FinalStage {
        BaseTemplateTenantAssociation build();
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder
            implements IdStage, CreatedAtStage, UpdatedAtStage, PublishedAtStage, VersionStage, _FinalStage {
        private String id;
        ...
        @java.lang.Override
        public Builder from(BaseTemplateTenantAssociation other) {
            id(other.getId());
        ...
        @java.lang.Override
        public BaseTemplateTenantAssociation build() {
            return new BaseTemplateTenantAssociation(
                    id, createdAt, updatedAt, publishedAt, version, additionalProperties);
        }
    }
}
