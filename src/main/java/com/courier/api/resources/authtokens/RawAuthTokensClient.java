...
public class RawAuthTokensClient {
    protected final ClientOptions clientOptions;

    public RawAuthTokensClient(ClientOptions clientOptions) {
     ...
     */
    public CourierHttpResponse<IssueTokenResponse> issueToken(IssueTokenParams request) {
     ...
     * Returns a new access token.
     */
    public CourierHttpResponse<IssueTokenResponse> issueToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new CourierHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), IssueTokenResponse.class), response);
            }
