...
public final class TemplateMessage implements IBaseMessage {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TemplateMessage && equalTo((TemplateMessage) other);
    }
    ...
    private boolean equalTo(TemplateMessage other) {
    ...
    public static final class Builder implements TemplateStage, ToStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(TemplateMessage other) {
            data(other.getData());
