...
public final class ElementalDividerNode implements IElementalBaseNode {
    ...
    /**
     * @return The CSS color to render the line with. For example, <code>#fff</code>
     */
    @JsonProperty("color")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ElementalDividerNode && equalTo((ElementalDividerNode) other);
    }
    ...
    private boolean equalTo(ElementalDividerNode other) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.channels, this.ref, this.if_, this.loop, this.color);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(ElementalDividerNode other) {
        ...
        public ElementalDividerNode build() {
            return new ElementalDividerNode(channels, ref, if_, loop, color, additionalProperties);
        }
    }
}
