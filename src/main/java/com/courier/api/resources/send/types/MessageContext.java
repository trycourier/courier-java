...
public final class MessageContext {
    ...
    private MessageContext(Optional<String> tenantId, Map<String, Object> additionalProperties) {
        this.tenantId = tenantId;
        this.additionalProperties = additionalProperties;
    }

    /**
     * @return An id of a tenant, see <a href="https://www.courier.com/docs/reference/tenants/">tenants api docs</a>.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MessageContext && equalTo((MessageContext) other);
    }
    ...
    private boolean equalTo(MessageContext other) {
    ...
    public static final class Builder {
        ...
        public Builder from(MessageContext other) {
        ...
        public MessageContext build() {
            return new MessageContext(tenantId, additionalProperties);
        }
    }
}
