...
public class CourierBuilder {
     ...
     */
    public CourierBuilder timeout(int timeout) {
     ...
     */
    public CourierBuilder maxRetries(int maxRetries) {
     ...
     */
    public CourierBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public CourierBuilder addHeader(String name, String value) {
    ...
    public Courier build() {
        ...
        return new Courier(buildClientOptions());
    }
}
