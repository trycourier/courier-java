...
public class AsyncCourierBuilder {
     ...
     */
    public AsyncCourierBuilder authorizationToken(String authorizationToken) {
        this.authorizationToken = authorizationToken;
        return this;
    }

    public AsyncCourierBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncCourierBuilder url(String url) {
     ...
     */
    public AsyncCourierBuilder timeout(int timeout) {
     ...
     */
    public AsyncCourierBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncCourierBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncCourierBuilder addHeader(String name, String value) {
    ...
    protected void setAuthentication(ClientOptions.Builder builder) {
        if (this.authorizationToken != null) {
            builder.addHeader("Authorization", "Bearer " + this.authorizationToken);
        }
    }
