                        ...
                        BaseMessageSendTo.To.UnionMember1.builder()
                            ...
                            .addFilter(
                                BaseMessageSendTo.To.UnionMember1.Filter.builder()
                                    .operator(
                                        BaseMessageSendTo.To.UnionMember1.Filter.Operator.MEMBER_OF
                                    )
                                    .path(BaseMessageSendTo.To.UnionMember1.Filter.Path.ACCOUNT_ID)
                                    .value("value")
                                    .build()
                            )
                            .listId("list_id")
                            ...
                            BaseMessageSendTo.To.UnionMember1.builder()
                                ...
                                .addFilter(
                                    BaseMessageSendTo.To.UnionMember1.Filter.builder()
                                        ...
                                        .path(
                                            BaseMessageSendTo.To.UnionMember1.Filter.Path.ACCOUNT_ID
                                        )
                                        .value("value")
                                        .build()
                                )
