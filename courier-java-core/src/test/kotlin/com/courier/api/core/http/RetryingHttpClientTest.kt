...
import com.courier.api.client.okhttp.OkHttpClient
import com.courier.api.core.RequestOptions
import com.courier.api.core.Sleeper
import com.courier.api.errors.CourierRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw CourierRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            CourierRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
