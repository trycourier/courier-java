...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TenantListUsersResponse].
         *
    ...
    /** A builder for [TenantListUsersResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tenantListUsersResponse: TenantListUsersResponse) = apply {
            hasMore = tenantListUsersResponse.hasMore
            type = tenantListUsersResponse.type
            url = tenantListUsersResponse.url
            cursor = tenantListUsersResponse.cursor
            items = tenantListUsersResponse.items.map { it.toMutableList() }
            nextUrl = tenantListUsersResponse.nextUrl
            additionalProperties = tenantListUsersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TenantListUsersResponse].
         *
         ...
         */
        fun build(): TenantListUsersResponse =
    ...
    fun validate(): TenantListUsersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TenantListUsersResponse &&
    ...
    override fun toString() =
        "TenantListUsersResponse{hasMore=$hasMore, type=$type, url=$url, cursor=$cursor, items=$items, nextUrl=$nextUrl, additionalProperties=$additionalProperties}"
}
