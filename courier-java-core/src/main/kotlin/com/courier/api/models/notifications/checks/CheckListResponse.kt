...
import com.courier.api.models.notifications.Check
...
private constructor(
    ...
    /** A builder for [CheckListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(checkListResponse: CheckListResponse) = apply {
            checks = checkListResponse.checks.map { it.toMutableList() }
            additionalProperties = checkListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CheckListResponse].
         *
    ...
    fun validate(): CheckListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CheckListResponse{checks=$checks, additionalProperties=$additionalProperties}"
}
