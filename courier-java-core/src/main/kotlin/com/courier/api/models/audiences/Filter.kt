...
private constructor(
    ...
    override fun hashCode(): Int = Objects.hash(unionMember0, nestedFilterConfig)

    override fun toString(): String =
        when {
            unionMember0 != null -> "Filter{unionMember0=$unionMember0}"
    ...
    companion object {
        ...
        @JvmStatic
        fun ofUnionMember0(unionMember0: UnionMember0) = Filter(unionMember0 = unionMember0)
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<UnionMember0>())?.let {
                            Filter(unionMember0 = it, _json = json)
                        },
