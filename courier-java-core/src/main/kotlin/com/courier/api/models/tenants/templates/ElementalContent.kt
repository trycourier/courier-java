...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [addElement] with `Element.ofUnionMember2(unionMember2)`. */
        fun addElement(unionMember2: Element.UnionMember2) =
            addElement(Element.ofUnionMember2(unionMember2))
        ...
        /** Alias for calling [addElement] with `Element.ofUnionMember6(unionMember6)`. */
        fun addElement(unionMember6: Element.UnionMember6) =
            addElement(Element.ofUnionMember6(unionMember6))
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                unionMember2 != null -> "Element{unionMember2=$unionMember2}"
                ...
                unionMember6 != null -> "Element{unionMember6=$unionMember6}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofUnionMember0(unionMember0: UnionMember0) = Element(unionMember0 = unionMember0)

            @JvmStatic
            fun ofUnionMember1(unionMember1: UnionMember1) = Element(unionMember1 = unionMember1)

            @JvmStatic
            fun ofUnionMember2(unionMember2: UnionMember2) = Element(unionMember2 = unionMember2)

            @JvmStatic
            fun ofUnionMember3(unionMember3: UnionMember3) = Element(unionMember3 = unionMember3)

            @JvmStatic
            fun ofUnionMember4(unionMember4: UnionMember4) = Element(unionMember4 = unionMember4)

            @JvmStatic
            fun ofUnionMember5(unionMember5: UnionMember5) = Element(unionMember5 = unionMember5)

            @JvmStatic
            fun ofUnionMember6(unionMember6: UnionMember6) = Element(unionMember6 = unionMember6)
        }

        /**
         * An interface that defines how to map each variant of [Element] to a value of type [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [Element] can contain an unknown variant if it was deserialized from
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<UnionMember2>())?.let {
                                Element(unionMember2 = it, _json = json)
                            },
                            ...
                            tryDeserialize(node, jacksonTypeRef<UnionMember6>())?.let {
                                Element(unionMember6 = it, _json = json)
                            },
                        )
                        .filterNotNull()
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.if_] with a well-typed [String] value instead.
                 ...
                 *
                 * You should usually call [Builder.loop] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("align")
                @ExcludeMissing
                align: JsonField<Alignment> = JsonMissing.of(),
                ...
                @ExcludeMissing
                locales: JsonField<Locales> = JsonMissing.of(),
            ...
            fun backgroundColor(): Optional<String> =
                backgroundColor.getOptional("background_color")
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.align] with a well-typed [Alignment] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.locales] with a well-typed [Locales] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.style] with a well-typed [Style] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
            ...
            /** Defaults to `button`. */
            class Style @JsonCreator private constructor(private val value: JsonField<String>) :
                Enum {
                ...
                enum class Value {
                    ...
                    LINK,
                    /**
                     * An enum member indicating that [Style] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
