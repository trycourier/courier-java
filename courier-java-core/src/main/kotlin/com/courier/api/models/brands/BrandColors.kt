...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.tertiary] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        fun build(): BrandColors =
            BrandColors(primary, secondary, tertiary, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "BrandColors{primary=$primary, secondary=$secondary, tertiary=$tertiary, additionalProperties=$additionalProperties}"
}
