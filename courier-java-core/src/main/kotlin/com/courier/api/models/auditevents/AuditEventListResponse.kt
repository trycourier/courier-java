...
private constructor(
    ...
    private val results: JsonField<List<AuditEvent>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<AuditEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<AuditEvent> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<AuditEvent>> = results
    ...
    class Builder internal constructor() {
        ...
        private var results: JsonField<MutableList<AuditEvent>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(auditEventListResponse: AuditEventListResponse) = apply {
            paging = auditEventListResponse.paging
            results = auditEventListResponse.results.map { it.toMutableList() }
        ...
        fun results(results: List<AuditEvent>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<AuditEvent>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<AuditEvent>>) = apply {
         ...
         */
        fun addResult(result: AuditEvent) = apply {
            results =
    ...
    override fun toString() =
        "AuditEventListResponse{paging=$paging, results=$results, additionalProperties=$additionalProperties}"
}
