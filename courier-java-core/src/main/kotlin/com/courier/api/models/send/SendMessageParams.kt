...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun message(content: Message.ContentMessage) = apply { body.message(content) }

        /** Alias for calling [message] with `Message.ofTemplate(template)`. */
        fun message(template: Message.TemplateMessage) = apply { body.message(template) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [message] with `Message.ofContent(content)`. */
            fun message(content: Message.ContentMessage) = message(Message.ofContent(content))

            /** Alias for calling [message] with `Message.ofTemplate(template)`. */
            fun message(template: Message.TemplateMessage) = message(Message.ofTemplate(template))
