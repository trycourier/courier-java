...
private constructor(
    ...
    private val results: JsonField<List<Brand>>,
    ...
    private constructor(
        ...
        @JsonProperty("results") @ExcludeMissing results: JsonField<List<Brand>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<Brand> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Brand>> = results
    ...
    class Builder internal constructor() {
        ...
        private var results: JsonField<MutableList<Brand>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(brandListResponse: BrandListResponse) = apply {
            paging = brandListResponse.paging
            results = brandListResponse.results.map { it.toMutableList() }
        ...
        fun results(results: List<Brand>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Brand>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Brand>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Brand] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Brand) = apply {
            results =
    ...
    override fun toString() =
        "BrandListResponse{paging=$paging, results=$results, additionalProperties=$additionalProperties}"
}
