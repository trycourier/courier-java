...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brandRetrieveParams: BrandRetrieveParams) = apply {
            brandId = brandRetrieveParams.brandId
        ...
        fun build(): BrandRetrieveParams =
            BrandRetrieveParams(brandId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "BrandRetrieveParams{brandId=$brandId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
