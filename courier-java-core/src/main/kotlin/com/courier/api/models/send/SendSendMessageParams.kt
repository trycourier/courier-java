    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("campaign")
                @ExcludeMissing
                fun _campaign(): JsonField<String> = campaign
                 ...
                 *
                 * Unlike [term], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.term] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
