...
private constructor(
    ...
    ) : this(created, name, published, settings, updated, version, id, snippets, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun published(): Long = published.getRequired("published")
    ...
    class Builder internal constructor() {
        ...
        /**
         * The date/time of when the brand was created. Represented in milliseconds since Unix
         * epoch.
         */
        ...
        /**
         * The date/time of when the brand was published. Represented in milliseconds since Unix
         * epoch.
         */
        fun published(published: Long) = published(JsonField.of(published))
        ...
        /**
         * The date/time of when the brand was updated. Represented in milliseconds since Unix
         * epoch.
         */
    ...
    override fun toString() =
        "Brand{created=$created, name=$name, published=$published, settings=$settings, updated=$updated, version=$version, id=$id, snippets=$snippets, additionalProperties=$additionalProperties}"
}
