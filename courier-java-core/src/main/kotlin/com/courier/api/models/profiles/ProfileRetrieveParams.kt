...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ProfileRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ProfileRetrieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(profileRetrieveParams: ProfileRetrieveParams) = apply {
            userId = profileRetrieveParams.userId
        ...
        /**
         * Returns an immutable instance of [ProfileRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ProfileRetrieveParams =
            ProfileRetrieveParams(userId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ProfileRetrieveParams{userId=$userId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
