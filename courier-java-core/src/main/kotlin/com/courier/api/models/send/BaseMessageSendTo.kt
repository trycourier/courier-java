...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BaseMessageSendTo]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BaseMessageSendTo]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(baseMessageSendTo: BaseMessageSendTo) = apply {
            to = baseMessageSendTo.to
            additionalProperties = baseMessageSendTo.additionalProperties.toMutableMap()
        }
        ...
        /** Alias for calling [to] with `To.ofAudienceRecipient(audienceRecipient)`. */
        fun to(audienceRecipient: To.AudienceRecipient) =
            to(To.ofAudienceRecipient(audienceRecipient))
        ...
        /** Alias for calling [to] with `To.ofUnionMember2(unionMember2)`. */
        fun to(unionMember2: To.UnionMember2) = to(To.ofUnionMember2(unionMember2))
        ...
        /** Alias for calling [to] with `To.ofSlackRecipient(slackRecipient)`. */
        fun to(slackRecipient: To.SlackRecipient) = to(To.ofSlackRecipient(slackRecipient))

        /** Alias for calling [to] with `To.ofMsTeamsRecipient(msTeamsRecipient)`. */
        fun to(msTeamsRecipient: To.MsTeamsRecipient) = to(To.ofMsTeamsRecipient(msTeamsRecipient))

        /** Alias for calling [to] with `To.ofRecipientData(recipientData)`. */
        fun to(recipientData: To.RecipientData) = to(To.ofRecipientData(recipientData))

        /** Alias for calling [to] with `To.ofPagerdutyRecipient(pagerdutyRecipient)`. */
        fun to(pagerdutyRecipient: To.PagerdutyRecipient) =
            to(To.ofPagerdutyRecipient(pagerdutyRecipient))

        /** Alias for calling [to] with `To.ofWebhookRecipient(webhookRecipient)`. */
        fun to(webhookRecipient: To.WebhookRecipient) = to(To.ofWebhookRecipient(webhookRecipient))
        ...
        /**
         * Returns an immutable instance of [BaseMessageSendTo].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BaseMessageSendTo = BaseMessageSendTo(to, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BaseMessageSendTo = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (to.asKnown().getOrNull()?.validity() ?: 0)
    ...
    private constructor(
        ...
        fun audienceRecipient(): Optional<AudienceRecipient> =
            Optional.ofNullable(audienceRecipient)
        ...
        fun slackRecipient(): Optional<SlackRecipient> = Optional.ofNullable(slackRecipient)

        fun msTeamsRecipient(): Optional<MsTeamsRecipient> = Optional.ofNullable(msTeamsRecipient)

        fun recipientData(): Optional<RecipientData> = Optional.ofNullable(recipientData)

        fun pagerdutyRecipient(): Optional<PagerdutyRecipient> =
            Optional.ofNullable(pagerdutyRecipient)

        fun webhookRecipient(): Optional<WebhookRecipient> = Optional.ofNullable(webhookRecipient)
        ...
        fun isSlackRecipient(): Boolean = slackRecipient != null

        fun isMsTeamsRecipient(): Boolean = msTeamsRecipient != null

        fun isRecipientData(): Boolean = recipientData != null
        ...
        fun asAudienceRecipient(): AudienceRecipient =
            audienceRecipient.getOrThrow("audienceRecipient")
        ...
        fun asSlackRecipient(): SlackRecipient = slackRecipient.getOrThrow("slackRecipient")

        fun asMsTeamsRecipient(): MsTeamsRecipient = msTeamsRecipient.getOrThrow("msTeamsRecipient")

        fun asRecipientData(): RecipientData = recipientData.getOrThrow("recipientData")

        fun asPagerdutyRecipient(): PagerdutyRecipient =
            pagerdutyRecipient.getOrThrow("pagerdutyRecipient")

        fun asWebhookRecipient(): WebhookRecipient = webhookRecipient.getOrThrow("webhookRecipient")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                audienceRecipient != null -> visitor.visitAudienceRecipient(audienceRecipient)
                ...
                slackRecipient != null -> visitor.visitSlackRecipient(slackRecipient)
                msTeamsRecipient != null -> visitor.visitMsTeamsRecipient(msTeamsRecipient)
                recipientData != null -> visitor.visitRecipientData(recipientData)
                pagerdutyRecipient != null -> visitor.visitPagerdutyRecipient(pagerdutyRecipient)
        ...
        fun validate(): To = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitAudienceRecipient(audienceRecipient: AudienceRecipient) {
                        audienceRecipient.validate()
                    }
                    ...
                    override fun visitSlackRecipient(slackRecipient: SlackRecipient) {
                        slackRecipient.validate()
                    }

                    override fun visitMsTeamsRecipient(msTeamsRecipient: MsTeamsRecipient) {
                        msTeamsRecipient.validate()
                    }

                    override fun visitRecipientData(recipientData: RecipientData) {
                        recipientData.validate()
                    }

                    override fun visitPagerdutyRecipient(pagerdutyRecipient: PagerdutyRecipient) {
                        pagerdutyRecipient.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitSlackRecipient(slackRecipient: SlackRecipient) =
                        slackRecipient.validity()

                    override fun visitMsTeamsRecipient(msTeamsRecipient: MsTeamsRecipient) =
                        msTeamsRecipient.validity()

                    override fun visitRecipientData(recipientData: RecipientData) =
                        recipientData.validity()

                    override fun visitPagerdutyRecipient(pagerdutyRecipient: PagerdutyRecipient) =
                        pagerdutyRecipient.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is To &&
                audienceRecipient == other.audienceRecipient &&
                ...
                recipientData == other.recipientData &&
        ...
        override fun toString(): String =
            when {
                audienceRecipient != null -> "To{audienceRecipient=$audienceRecipient}"
                unionMember1 != null -> "To{unionMember1=$unionMember1}"
                unionMember2 != null -> "To{unionMember2=$unionMember2}"
                userRecipient != null -> "To{userRecipient=$userRecipient}"
                slackRecipient != null -> "To{slackRecipient=$slackRecipient}"
                msTeamsRecipient != null -> "To{msTeamsRecipient=$msTeamsRecipient}"
                recipientData != null -> "To{recipientData=$recipientData}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofAudienceRecipient(audienceRecipient: AudienceRecipient) =
                To(audienceRecipient = audienceRecipient)

            @JvmStatic
            fun ofUnionMember1(unionMember1: UnionMember1) = To(unionMember1 = unionMember1)

            @JvmStatic
            fun ofUnionMember2(unionMember2: UnionMember2) = To(unionMember2 = unionMember2)

            @JvmStatic
            fun ofUserRecipient(userRecipient: UserRecipient) = To(userRecipient = userRecipient)

            @JvmStatic
            fun ofSlackRecipient(slackRecipient: SlackRecipient) =
                To(slackRecipient = slackRecipient)

            @JvmStatic
            fun ofMsTeamsRecipient(msTeamsRecipient: MsTeamsRecipient) =
                To(msTeamsRecipient = msTeamsRecipient)

            @JvmStatic
            fun ofRecipientData(recipientData: RecipientData) = To(recipientData = recipientData)

            @JvmStatic
            fun ofPagerdutyRecipient(pagerdutyRecipient: PagerdutyRecipient) =
                To(pagerdutyRecipient = pagerdutyRecipient)
        ...
        interface Visitor<out T> {
            ...
            fun visitAudienceRecipient(audienceRecipient: AudienceRecipient): T
            ...
            fun visitSlackRecipient(slackRecipient: SlackRecipient): T

            fun visitMsTeamsRecipient(msTeamsRecipient: MsTeamsRecipient): T

            fun visitRecipientData(recipientData: RecipientData): T

            fun visitPagerdutyRecipient(pagerdutyRecipient: PagerdutyRecipient): T
        ...
        internal class Serializer : BaseSerializer<To>(To::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.audienceRecipient != null ->
                        generator.writeObject(value.audienceRecipient)
                    ...
                    value.slackRecipient != null -> generator.writeObject(value.slackRecipient)
                    value.msTeamsRecipient != null -> generator.writeObject(value.msTeamsRecipient)
                    value.recipientData != null -> generator.writeObject(value.recipientData)
                    value.pagerdutyRecipient != null ->
                        generator.writeObject(value.pagerdutyRecipient)
                    value.webhookRecipient != null -> generator.writeObject(value.webhookRecipient)
        ...
        private constructor(
             ...
             *
             * Unlike [audienceId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("audience_id")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * yet supported value.
                 */
                fun audienceId(audienceId: JsonField<String>) = apply {
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.path] with a well-typed [Path] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                ...
                class Path @JsonCreator private constructor(private val value: JsonField<String>) :
                    ...
                    enum class Value {
                        ACCOUNT_ID,
                        /**
                         * An enum member indicating that [Path] was instantiated with an unknown
                         * value.
                         */
                        _UNKNOWN,
                    }
        ...
        private constructor(
             ...
             *
             * Unlike [listPattern], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("list_pattern")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                fun listPattern(listPattern: String?) =
                    listPattern(JsonField.ofNullable(listPattern))

                /** Alias for calling [Builder.listPattern] with `listPattern.orElse(null)`. */
                fun listPattern(listPattern: Optional<String>) =
                    listPattern(listPattern.getOrNull())
            ...
            private val hashCode: Int by lazy {
                Objects.hash(data, listPattern, additionalProperties)
            }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.slack] with a well-typed [Slack] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (slack.asKnown().getOrNull()?.validity() ?: 0)
            ...
            private constructor(
                ...
                fun <T> accept(visitor: Visitor<T>): T =
                    when {
                        ...
                        sendToSlackUserId != null ->
                            visitor.visitSendToSlackUserId(sendToSlackUserId)
                        else -> visitor.unknown(_json)
                    }
                ...
                fun validate(): Slack = apply {
                    ...
                    accept(
                        object : Visitor<Unit> {
                            ...
                            override fun visitSendToSlackUserId(
                ...
                /**
                 * An interface that defines how to map each variant of [Slack] to a value of type
                 * [T].
                 */
                interface Visitor<out T> {
                     ...
                     *
                     * An instance of [Slack] can contain an unknown variant if it was deserialized
                ...
                internal class Deserializer : BaseDeserializer<Slack>(Slack::class) {
                    ...
                    override fun ObjectCodec.deserialize(node: JsonNode): Slack {
                        ...
                        val bestMatches =
                            sequenceOf(
                                    tryDeserialize(node, jacksonTypeRef<SendToSlackChannel>())
                                        ?.let { Slack(sendToSlackChannel = it, _json = json) },
                ...
                private constructor(
                     ...
                     *
                     * Unlike [channel], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("channel")
                    @ExcludeMissing
                    fun _channel(): JsonField<String> = channel
                    ...
                    class Builder internal constructor() {
                        ...
                        fun accessToken(accessToken: String) =
                            accessToken(JsonField.of(accessToken))
                         ...
                         *
                         * You should usually call [Builder.channel] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(sendToSlackEmail: SendToSlackEmail) = apply {
                            ...
                            additionalProperties =
                                sendToSlackEmail.additionalProperties.toMutableMap()
                        }
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(sendToSlackUserId: SendToSlackUserId) = apply {
                            ...
                            additionalProperties =
                                sendToSlackUserId.additionalProperties.toMutableMap()
                        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                msTeams: JsonField<MsTeams> = JsonMissing.of()
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.msTeams] with a well-typed [MsTeams] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                interface Visitor<out T> {
                    ...
                    fun visitSendToMsTeamsChannelId(
                        sendToMsTeamsChannelId: SendToMsTeamsChannelId
                    ): T
                     ...
                     *
                     * An instance of [MsTeams] can contain an unknown variant if it was
                ...
                internal class Deserializer : BaseDeserializer<MsTeams>(MsTeams::class) {
                    ...
                    override fun ObjectCodec.deserialize(node: JsonNode): MsTeams {
                        ...
                        val bestMatches =
                            sequenceOf(
                                    tryDeserialize(node, jacksonTypeRef<SendToMsTeamsUserId>())
                                        ?.let { MsTeams(sendToMsTeamsUserId = it, _json = json) },
                                    tryDeserialize(node, jacksonTypeRef<SendToMsTeamsEmail>())
                                        ?.let { MsTeams(sendToMsTeamsEmail = it, _json = json) },
                ...
                private constructor(
                     ...
                     *
                     * Unlike [tenantId], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("tenant_id")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.serviceUrl] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.tenantId] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun tenantId(tenantId: JsonField<String>) = apply {
                ...
                private constructor(
                     ...
                     *
                     * Unlike [channelId], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("channel_id")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.channelId] with a well-typed [String]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.conversationId] with a well-typed
                ...
                private constructor(
                     ...
                     *
                     * Unlike [teamId], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("team_id")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        @JvmSynthetic
                        internal fun from(sendToMsTeamsChannelName: SendToMsTeamsChannelName) =
                            apply {
                        ...
                        fun channelName(channelName: String) =
                            channelName(JsonField.of(channelName))
        ...
        private constructor(
             ...
             *
             * Unlike [pagerduty], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("pagerduty")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * yet supported value.
                 */
                fun pagerduty(pagerduty: JsonField<Pagerduty>) = apply {
            ...
            private constructor(
                 ...
                 *
                 * Unlike [eventAction], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("event_action")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [routingKey], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("routing_key")
                @ExcludeMissing
                ...
                @JsonProperty("severity")
                @ExcludeMissing
                fun _severity(): JsonField<String> = severity
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.eventAction] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    fun routingKey(routingKey: String?) =
                        routingKey(JsonField.ofNullable(routingKey))

                    /** Alias for calling [Builder.routingKey] with `routingKey.orElse(null)`. */
                    fun routingKey(routingKey: Optional<String>) =
                        routingKey(routingKey.getOrNull())
        ...
        private constructor(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     * [Authentication] value instead. This method is primarily for setting the
                ...
                private constructor(
                    ...
                    private constructor(
                        @JsonProperty("mode")
                        @ExcludeMissing
                        mode: JsonField<Mode> = JsonMissing.of(),
                        @JsonProperty("token")
                        @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(authentication: Authentication) = apply {
                            ...
                            additionalProperties =
                                authentication.additionalProperties.toMutableMap()
                        }
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        enum class Value {
                            ...
                            BEARER,
                            /**
                             * An enum member indicating that [Mode] was instantiated with an
                             * unknown value.
                             */
                            _UNKNOWN,
                        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BaseMessageSendTo &&
            to == other.to &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(to, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BaseMessageSendTo{to=$to, additionalProperties=$additionalProperties}"
}
