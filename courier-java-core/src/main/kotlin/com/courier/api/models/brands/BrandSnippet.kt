...
private constructor(
    ...
    private val hashCode: Int by lazy { Objects.hash(format, name, value, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BrandSnippet{format=$format, name=$name, value=$value, additionalProperties=$additionalProperties}"
}
