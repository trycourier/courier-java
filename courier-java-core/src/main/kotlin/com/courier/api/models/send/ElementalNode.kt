...
private constructor(
    ...
    override fun toString(): String =
        when {
            ...
            type != null -> "ElementalNode{type=$type}"
    ...
    companion object {
        ...
        @JvmStatic fun ofType(type: Type) = ElementalNode(type = type)
            ...
            val bestMatches =
                sequenceOf(
                        ...
                        tryDeserialize(node, jacksonTypeRef<Type>())?.let {
                            ElementalNode(type = it, _json = json)
                        },
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun addElement(type: Type) = addElement(ElementalNode.ofType(type))
