...
private constructor(
    ...
    /** A builder for [AuthIssueTokenResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authIssueTokenResponse: AuthIssueTokenResponse) = apply {
            token = authIssueTokenResponse.token
            additionalProperties = authIssueTokenResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AuthIssueTokenResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthIssueTokenResponse =
            AuthIssueTokenResponse(token, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): AuthIssueTokenResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthIssueTokenResponse &&
            token == other.token &&
    ...
    override fun toString() =
        "AuthIssueTokenResponse{token=$token, additionalProperties=$additionalProperties}"
}
