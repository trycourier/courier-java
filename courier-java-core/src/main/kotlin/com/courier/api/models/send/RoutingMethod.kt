...
class RoutingMethod @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    enum class Value {
        ...
        SINGLE,
        /**
         * An enum member indicating that [RoutingMethod] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
