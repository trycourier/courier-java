...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListUpdateParams].
         *
    ...
    /** A builder for [ListUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listUpdateParams: ListUpdateParams) = apply {
            listId = listUpdateParams.listId
            body = listUpdateParams.body.toBuilder()
            additionalHeaders = listUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = listUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ListUpdateParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, preferences, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), preferences, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(name, preferences, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, preferences=$preferences, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListUpdateParams &&
            listId == other.listId &&
            body == other.body &&
    ...
    override fun toString() =
        "ListUpdateParams{listId=$listId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
