...
private constructor(
    ...
    /** A builder for [ProfileCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileCreateResponse: ProfileCreateResponse) = apply {
            status = profileCreateResponse.status
            additionalProperties = profileCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileCreateResponse].
         *
         ...
         */
        fun build(): ProfileCreateResponse =
    ...
    fun validate(): ProfileCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "ProfileCreateResponse{status=$status, additionalProperties=$additionalProperties}"
}
