...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(auditEventListParams: AuditEventListParams) = apply {
            cursor = auditEventListParams.cursor
        ...
        fun build(): AuditEventListParams =
            AuditEventListParams(cursor, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AuditEventListParams{cursor=$cursor, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
