...
package com.courier.api.services.blocking.lists
...
class SubscriptionServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun add(params: SubscriptionAddParams, requestOptions: RequestOptions) {
        // post /lists/{list_id}/subscriptions
        withRawResponse().add(params, requestOptions)
    }

    override fun subscribe(params: SubscriptionSubscribeParams, requestOptions: RequestOptions) {
        // put /lists/{list_id}/subscriptions
        withRawResponse().subscribe(params, requestOptions)
    }
    ...
    override fun subscribeUser(
        ...
        withRawResponse().subscribeUser(params, requestOptions)
    }
    ...
    override fun unsubscribeUser(
        ...
        withRawResponse().unsubscribeUser(params, requestOptions)
    }
