...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = slack.accept(new Slack.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitSendToSlackChannel(SendToSlackChannel sendToSlackChannel) {
     *         return Optional.of(sendToSlackChannel.toString());
     *     }
     *
     *     // ...
     *
