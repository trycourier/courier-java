...
private constructor(
    ...
    private val results: JsonField<List<Provider>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<Provider>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<Provider> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Provider>> = results
    ...
    class Builder internal constructor() {
        ...
        private var results: JsonField<MutableList<Provider>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(providerListResponse: ProviderListResponse) = apply {
            paging = providerListResponse.paging
            results = providerListResponse.results.map { it.toMutableList() }
        ...
        fun results(results: List<Provider>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Provider>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<Provider>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Provider] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Provider) = apply {
            results =
    ...
    override fun toString() =
        "ProviderListResponse{paging=$paging, results=$results, additionalProperties=$additionalProperties}"
}
