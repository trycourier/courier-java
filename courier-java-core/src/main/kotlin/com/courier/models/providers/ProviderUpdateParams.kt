...
/**
 * Replaces a provider's configuration in full, clearing any field you omit rather than merging it.
...
private constructor(
    ...
    /**
     * Provider-specific settings (snake_case keys). Replaces the full settings object — omitted
     * settings fields are removed. Use the catalog endpoint to check required fields.
     *
     * @throws CourierInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /** A builder for [ProviderUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerUpdateParams: ProviderUpdateParams) = apply {
            id = providerUpdateParams.id
            body = providerUpdateParams.body.toBuilder()
            additionalHeaders = providerUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = providerUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProviderUpdateParams].
         *
         ...
         */
        fun build(): ProviderUpdateParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * omitted settings fields are removed. Use the catalog endpoint to check required
             * fields.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProviderUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ProviderUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
