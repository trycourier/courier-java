...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerListParams: ProviderListParams) = apply {
            cursor = providerListParams.cursor
            additionalHeaders = providerListParams.additionalHeaders.toBuilder()
            additionalQueryParams = providerListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): ProviderListParams =
            ProviderListParams(cursor, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ProviderListParams{cursor=$cursor, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
