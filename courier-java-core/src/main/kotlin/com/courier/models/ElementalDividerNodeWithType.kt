...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ElementalDividerNodeWithType].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ElementalDividerNodeWithType]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(elementalDividerNodeWithType: ElementalDividerNodeWithType) = apply {
            channels = elementalDividerNodeWithType.channels.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [ElementalDividerNodeWithType].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ElementalDividerNodeWithType =
    ...
    fun validate(): ElementalDividerNodeWithType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ElementalDividerNodeWithType &&
