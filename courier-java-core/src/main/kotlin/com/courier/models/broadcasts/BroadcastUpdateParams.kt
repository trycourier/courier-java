...
/**
 * Update a broadcast's name. Content is edited via the broadcast's notification template, not this
 * endpoint.
 */
class BroadcastUpdateParams
private constructor(
    private val broadcastId: String?,
    private val updateBroadcastRequest: UpdateBroadcastRequest,
    ...
    fun updateBroadcastRequest(): UpdateBroadcastRequest = updateBroadcastRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        updateBroadcastRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var updateBroadcastRequest: UpdateBroadcastRequest? = null
        ...
        internal fun from(broadcastUpdateParams: BroadcastUpdateParams) = apply {
            ...
            updateBroadcastRequest = broadcastUpdateParams.updateBroadcastRequest
        ...
        /** Request body for updating a broadcast. Only the name is mutable. */
        fun updateBroadcastRequest(updateBroadcastRequest: UpdateBroadcastRequest) = apply {
            this.updateBroadcastRequest = updateBroadcastRequest
        }
        ...
        fun build(): BroadcastUpdateParams =
            BroadcastUpdateParams(
                broadcastId,
                checkRequired("updateBroadcastRequest", updateBroadcastRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): UpdateBroadcastRequest = updateBroadcastRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BroadcastUpdateParams &&
            ...
            updateBroadcastRequest == other.updateBroadcastRequest &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(broadcastId, updateBroadcastRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "BroadcastUpdateParams{broadcastId=$broadcastId, updateBroadcastRequest=$updateBroadcastRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
