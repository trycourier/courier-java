...
class ScheduleBroadcastRequest
...
private constructor(
    ...
    /**
     * Wall-clock timestamp of the future send, no timezone offset (e.g. "2026-07-21T20:00:00"). The
     * zone is given by `timezone`.
     *
     * @throws CourierInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun scheduledTo(): String = scheduledTo.getRequired("scheduled_to")
    ...
    /** A builder for [ScheduleBroadcastRequest]. */
    class Builder internal constructor() {

        private var recipientId: JsonField<String>? = null
        private var recipientType: JsonField<RecipientType>? = null
        private var scheduledTo: JsonField<String>? = null
        private var timezone: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(scheduleBroadcastRequest: ScheduleBroadcastRequest) = apply {
            recipientId = scheduleBroadcastRequest.recipientId
            recipientType = scheduleBroadcastRequest.recipientType
            scheduledTo = scheduleBroadcastRequest.scheduledTo
            timezone = scheduleBroadcastRequest.timezone
            additionalProperties = scheduleBroadcastRequest.additionalProperties.toMutableMap()
        }
         ...
         */
        fun scheduledTo(scheduledTo: String) = scheduledTo(JsonField.of(scheduledTo))
        ...
        /**
         * Returns an immutable instance of [ScheduleBroadcastRequest].
         *
     ...
     *   expected type.
     */
    fun validate(): ScheduleBroadcastRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduleBroadcastRequest &&
    ...
    override fun toString() =
        "ScheduleBroadcastRequest{recipientId=$recipientId, recipientType=$recipientType, scheduledTo=$scheduledTo, timezone=$timezone, additionalProperties=$additionalProperties}"
}
