...
private constructor(
    ...
    fun postTenantTemplatePublishRequest(): Optional<PostTenantTemplatePublishRequest> =
    ...
    class Builder internal constructor() {
         ...
         */
        fun postTenantTemplatePublishRequest(
            postTenantTemplatePublishRequest: Optional<PostTenantTemplatePublishRequest>
    ...
    fun _body(): Optional<PostTenantTemplatePublishRequest> =
        Optional.ofNullable(postTenantTemplatePublishRequest)
