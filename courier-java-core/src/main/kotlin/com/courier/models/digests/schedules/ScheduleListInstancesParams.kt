...
private constructor(
    ...
    /** A builder for [ScheduleListInstancesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduleListInstancesParams: ScheduleListInstancesParams) = apply {
            scheduleId = scheduleListInstancesParams.scheduleId
            cursor = scheduleListInstancesParams.cursor
            limit = scheduleListInstancesParams.limit
            additionalHeaders = scheduleListInstancesParams.additionalHeaders.toBuilder()
            additionalQueryParams = scheduleListInstancesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScheduleListInstancesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScheduleListInstancesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduleListInstancesParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(scheduleId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ScheduleListInstancesParams{scheduleId=$scheduleId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
