...
/**
 * List runs of the workspace's v2 Automations, newest first, filtered by status, Template, or date
 * range and paged by cursor. Journey (v3) runs are listed by `GET /journeys/runs` instead — the two
 * surfaces never return each other's runs. Runs are retained for 95 days.
 */
class RunListParams
private constructor(
