...
private constructor(
    ...
    /** A builder for [WorkspacePreferenceTopicReplaceRequest]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            defaultStatus = workspacePreferenceTopicReplaceRequest.defaultStatus
            name = workspacePreferenceTopicReplaceRequest.name
            allowedPreferences =
            ...
            routingOptions =
                workspacePreferenceTopicReplaceRequest.routingOptions.map { it.toMutableList() }
            topicData = workspacePreferenceTopicReplaceRequest.topicData
            additionalProperties =
                workspacePreferenceTopicReplaceRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WorkspacePreferenceTopicReplaceRequest].
         *
         ...
         */
        fun build(): WorkspacePreferenceTopicReplaceRequest =
            WorkspacePreferenceTopicReplaceRequest(
     ...
     *   expected type.
     */
    fun validate(): WorkspacePreferenceTopicReplaceRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkspacePreferenceTopicReplaceRequest &&
    ...
    override fun toString() =
        "WorkspacePreferenceTopicReplaceRequest{defaultStatus=$defaultStatus, name=$name, allowedPreferences=$allowedPreferences, includeUnsubscribeHeader=$includeUnsubscribeHeader, routingOptions=$routingOptions, topicData=$topicData, additionalProperties=$additionalProperties}"
}
