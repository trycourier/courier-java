...
class WorkspacePreferenceGetResponse
...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun topics(): List<WorkspacePreferenceTopicGetResponse> = topics.getRequired("topics")
    ...
    @JsonProperty("topics")
    @ExcludeMissing
    fun _topics(): JsonField<List<WorkspacePreferenceTopicGetResponse>> = topics
    ...
    /** A builder for [WorkspacePreferenceGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workspacePreferenceGetResponse: WorkspacePreferenceGetResponse) = apply {
            id = workspacePreferenceGetResponse.id
            created = workspacePreferenceGetResponse.created
            hasCustomRouting = workspacePreferenceGetResponse.hasCustomRouting
            name = workspacePreferenceGetResponse.name
            routingOptions =
            ...
            additionalProperties =
                workspacePreferenceGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /** The topics contained in this workspace preference. */
        fun topics(topics: List<WorkspacePreferenceTopicGetResponse>) = topics(JsonField.of(topics))
         ...
         */
        fun topics(topics: JsonField<List<WorkspacePreferenceTopicGetResponse>>) = apply {
            this.topics = topics.map { it.toMutableList() }
        }

        /**
         * Adds a single [WorkspacePreferenceTopicGetResponse] to [topics].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTopic(topic: WorkspacePreferenceTopicGetResponse) = apply {
            topics =
        ...
        /**
         * Returns an immutable instance of [WorkspacePreferenceGetResponse].
         *
         ...
         */
        fun build(): WorkspacePreferenceGetResponse =
            WorkspacePreferenceGetResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): WorkspacePreferenceGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkspacePreferenceGetResponse &&
            id == other.id &&
