 ...
 * `NotificationTemplateCreateRequest`, `notification.content` is not required to place its elements
 * inside a channel block: the requirement applies to creation only, so templates already stored
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(notificationTemplateUpdateRequest: NotificationTemplateUpdateRequest) =
            apply {
                notification = notificationTemplateUpdateRequest.notification
                state = notificationTemplateUpdateRequest.state
                additionalProperties =
                    notificationTemplateUpdateRequest.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Template state after update. Case-insensitive input, normalized to uppercase in the
         ...
         */
        fun build(): NotificationTemplateUpdateRequest =
            NotificationTemplateUpdateRequest(
     ...
     *   expected type.
     */
    fun validate(): NotificationTemplateUpdateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NotificationTemplateUpdateRequest &&
    ...
    override fun toString() =
        "NotificationTemplateUpdateRequest{notification=$notification, state=$state, additionalProperties=$additionalProperties}"
}
