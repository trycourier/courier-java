...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(baseCheck: BaseCheck) = apply {
            id = baseCheck.id
            status = baseCheck.status
            type = baseCheck.type
            additionalProperties = baseCheck.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BaseCheck].
         *
    ...
    override fun toString() =
        "BaseCheck{id=$id, status=$status, type=$type, additionalProperties=$additionalProperties}"
}
