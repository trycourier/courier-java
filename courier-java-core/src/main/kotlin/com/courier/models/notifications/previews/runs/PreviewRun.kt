...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PreviewRun].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(previewRun: PreviewRun) = apply {
            id = previewRun.id
            createdAt = previewRun.createdAt
            deviceIds = previewRun.deviceIds.map { it.toMutableList() }
            status = previewRun.status
            templateId = previewRun.templateId
            failureReason = previewRun.failureReason
            templateVersion = previewRun.templateVersion
            additionalProperties = previewRun.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PreviewRun].
         *
    ...
    override fun toString() =
        "PreviewRun{id=$id, createdAt=$createdAt, deviceIds=$deviceIds, status=$status, templateId=$templateId, failureReason=$failureReason, templateVersion=$templateVersion, additionalProperties=$additionalProperties}"
}
