...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = notificationRetrieveContentResponse.accept(new NotificationRetrieveContentResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitContentGet(NotificationContentGetResponse contentGet) {
     *         return Optional.of(contentGet.toString());
     *     }
     *
     *     // ...
     *
