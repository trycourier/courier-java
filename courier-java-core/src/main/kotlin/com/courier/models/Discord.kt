...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = discord.accept(new Discord.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitSendToChannel(SendToChannel sendToChannel) {
     *         return Optional.of(sendToChannel.toString());
     *     }
     *
     *     // ...
     *
