 ...
 * Any key-value pairs that exist in the profile but fail to be included in the `PUT` request will
 * be removed from the profile. Remember, a `PUT` update is a full replacement of the data. For
 * partial updates, use the [Patch](https://www.courier.com/docs/reference/profiles/patch/) request.
 */
class ProfileReplaceParams
private constructor(
     ...
     */
    fun profile(): Profile = body.profile()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileReplaceParams].
         *
    ...
    /** A builder for [ProfileReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileReplaceParams: ProfileReplaceParams) = apply {
            userId = profileReplaceParams.userId
            body = profileReplaceParams.body.toBuilder()
            additionalHeaders = profileReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = profileReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileReplaceParams].
         *
         ...
         */
        fun build(): ProfileReplaceParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("profile", profile), additionalProperties.toMutableMap())
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileReplaceParams &&
            userId == other.userId &&
            body == other.body &&
    ...
    override fun toString() =
        "ProfileReplaceParams{userId=$userId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
