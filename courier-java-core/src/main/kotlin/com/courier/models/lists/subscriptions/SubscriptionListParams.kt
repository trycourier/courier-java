...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionListParams: SubscriptionListParams) = apply {
            listId = subscriptionListParams.listId
    ...
    override fun hashCode(): Int =
        Objects.hash(listId, cursor, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SubscriptionListParams{listId=$listId, cursor=$cursor, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
