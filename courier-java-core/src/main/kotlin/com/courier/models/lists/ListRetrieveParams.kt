...
private constructor(
    ...
    /** A builder for [ListRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listRetrieveParams: ListRetrieveParams) = apply {
            listId = listRetrieveParams.listId
            additionalHeaders = listRetrieveParams.additionalHeaders.toBuilder()
        ...
        fun build(): ListRetrieveParams =
            ListRetrieveParams(listId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int = Objects.hash(listId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ListRetrieveParams{listId=$listId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
