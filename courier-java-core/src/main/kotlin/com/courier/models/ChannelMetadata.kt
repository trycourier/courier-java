...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelMetadata: ChannelMetadata) = apply {
            utm = channelMetadata.utm
            additionalProperties = channelMetadata.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChannelMetadata].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ChannelMetadata = ChannelMetadata(utm, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ChannelMetadata = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "ChannelMetadata{utm=$utm, additionalProperties=$additionalProperties}"
}
