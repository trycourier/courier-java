...
private constructor(
    ...
    /** A builder for [RoutingStrategyCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(routingStrategyCreateRequest: RoutingStrategyCreateRequest) = apply {
            name = routingStrategyCreateRequest.name
            routing = routingStrategyCreateRequest.routing
            channels = routingStrategyCreateRequest.channels
            description = routingStrategyCreateRequest.description
            providers = routingStrategyCreateRequest.providers
            tags = routingStrategyCreateRequest.tags.map { it.toMutableList() }
            additionalProperties = routingStrategyCreateRequest.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): RoutingStrategyCreateRequest =
    ...
    fun validate(): RoutingStrategyCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoutingStrategyCreateRequest &&
            name == other.name &&
    ...
    override fun toString() =
        "RoutingStrategyCreateRequest{name=$name, routing=$routing, channels=$channels, description=$description, providers=$providers, tags=$tags, additionalProperties=$additionalProperties}"
}
