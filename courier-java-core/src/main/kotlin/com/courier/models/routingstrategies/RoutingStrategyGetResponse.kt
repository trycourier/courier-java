...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun channels(): MessageChannels = channels.getRequired("channels")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun providers(): MessageProviders = providers.getRequired("providers")
    ...
    /** A builder for [RoutingStrategyGetResponse]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var channels: JsonField<MessageChannels>? = null
        private var created: JsonField<Long>? = null
        private var creator: JsonField<String>? = null
        private var name: JsonField<String>? = null
        private var providers: JsonField<MessageProviders>? = null
        ...
        @JvmSynthetic
        internal fun from(routingStrategyGetResponse: RoutingStrategyGetResponse) = apply {
            id = routingStrategyGetResponse.id
            channels = routingStrategyGetResponse.channels
            created = routingStrategyGetResponse.created
            creator = routingStrategyGetResponse.creator
            name = routingStrategyGetResponse.name
            providers = routingStrategyGetResponse.providers
            routing = routingStrategyGetResponse.routing
            description = routingStrategyGetResponse.description
            tags = routingStrategyGetResponse.tags.map { it.toMutableList() }
            updated = routingStrategyGetResponse.updated
            updater = routingStrategyGetResponse.updater
            additionalProperties = routingStrategyGetResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): RoutingStrategyGetResponse =
    ...
    fun validate(): RoutingStrategyGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoutingStrategyGetResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "RoutingStrategyGetResponse{id=$id, channels=$channels, created=$created, creator=$creator, name=$name, providers=$providers, routing=$routing, description=$description, tags=$tags, updated=$updated, updater=$updater, additionalProperties=$additionalProperties}"
}
