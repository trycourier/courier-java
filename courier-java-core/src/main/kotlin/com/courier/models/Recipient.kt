...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun preferences(): Optional<ProfilePreferences> = preferences.getOptional("preferences")
    ...
    class Builder internal constructor() {
        ...
        fun preferences(preferences: Optional<ProfilePreferences>) =
            preferences(preferences.getOrNull())

        /**
         * Sets [Builder.preferences] to an arbitrary JSON value.
         *
         * You should usually call [Builder.preferences] with a well-typed [ProfilePreferences]
    ...
    override fun toString() =
        "Recipient{accountId=$accountId, context=$context, data=$data, email=$email, listId=$listId, locale=$locale, phoneNumber=$phoneNumber, preferences=$preferences, tenantId=$tenantId, userId=$userId, additionalProperties=$additionalProperties}"
}
