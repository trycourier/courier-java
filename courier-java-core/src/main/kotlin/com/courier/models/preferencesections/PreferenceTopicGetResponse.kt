...
class PreferenceTopicGetResponse
...
private constructor(
    ...
    /** A builder for [PreferenceTopicGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(preferenceTopicGetResponse: PreferenceTopicGetResponse) = apply {
            id = preferenceTopicGetResponse.id
            allowedPreferences =
                preferenceTopicGetResponse.allowedPreferences.map { it.toMutableList() }
            created = preferenceTopicGetResponse.created
            defaultStatus = preferenceTopicGetResponse.defaultStatus
            includeUnsubscribeHeader = preferenceTopicGetResponse.includeUnsubscribeHeader
            name = preferenceTopicGetResponse.name
            routingOptions = preferenceTopicGetResponse.routingOptions.map { it.toMutableList() }
            topicData = preferenceTopicGetResponse.topicData
            updated = preferenceTopicGetResponse.updated
            creator = preferenceTopicGetResponse.creator
            updater = preferenceTopicGetResponse.updater
            additionalProperties = preferenceTopicGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PreferenceTopicGetResponse].
         *
         ...
         */
        fun build(): PreferenceTopicGetResponse =
     ...
     *   expected type.
     */
    fun validate(): PreferenceTopicGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PreferenceTopicGetResponse &&
            id == other.id &&
