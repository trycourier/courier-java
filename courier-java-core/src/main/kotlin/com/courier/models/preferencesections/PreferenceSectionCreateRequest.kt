...
class PreferenceSectionCreateRequest
...
private constructor(
    ...
    /** A builder for [PreferenceSectionCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(preferenceSectionCreateRequest: PreferenceSectionCreateRequest) = apply {
            name = preferenceSectionCreateRequest.name
            hasCustomRouting = preferenceSectionCreateRequest.hasCustomRouting
            routingOptions =
                preferenceSectionCreateRequest.routingOptions.map { it.toMutableList() }
            additionalProperties =
                preferenceSectionCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PreferenceSectionCreateRequest].
         *
         ...
         */
        fun build(): PreferenceSectionCreateRequest =
            PreferenceSectionCreateRequest(
     ...
     *   expected type.
     */
    fun validate(): PreferenceSectionCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PreferenceSectionCreateRequest &&
            name == other.name &&
    ...
    override fun toString() =
        "PreferenceSectionCreateRequest{name=$name, hasCustomRouting=$hasCustomRouting, routingOptions=$routingOptions, additionalProperties=$additionalProperties}"
}
