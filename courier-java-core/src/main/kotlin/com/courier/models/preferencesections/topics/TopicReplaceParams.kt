...
private constructor(
    ...
    private val preferenceTopicReplaceRequest: PreferenceTopicReplaceRequest,
     ...
     * fields are cleared.
     */
    fun preferenceTopicReplaceRequest(): PreferenceTopicReplaceRequest =
        preferenceTopicReplaceRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        preferenceTopicReplaceRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var preferenceTopicReplaceRequest: PreferenceTopicReplaceRequest? = null
        ...
        internal fun from(topicReplaceParams: TopicReplaceParams) = apply {
            ...
            preferenceTopicReplaceRequest = topicReplaceParams.preferenceTopicReplaceRequest
         ...
         */
        fun preferenceTopicReplaceRequest(
            preferenceTopicReplaceRequest: PreferenceTopicReplaceRequest
        ) = apply { this.preferenceTopicReplaceRequest = preferenceTopicReplaceRequest }
        ...
        fun build(): TopicReplaceParams =
            TopicReplaceParams(
                ...
                topicId,
                checkRequired("preferenceTopicReplaceRequest", preferenceTopicReplaceRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): PreferenceTopicReplaceRequest = preferenceTopicReplaceRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TopicReplaceParams &&
            ...
            preferenceTopicReplaceRequest == other.preferenceTopicReplaceRequest &&
    ...
    override fun toString() =
        "TopicReplaceParams{sectionId=$sectionId, topicId=$topicId, preferenceTopicReplaceRequest=$preferenceTopicReplaceRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
