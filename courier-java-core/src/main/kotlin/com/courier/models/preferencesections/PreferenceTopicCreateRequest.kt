...
class PreferenceTopicCreateRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PreferenceTopicCreateRequest].
         *
    ...
    /** A builder for [PreferenceTopicCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(preferenceTopicCreateRequest: PreferenceTopicCreateRequest) = apply {
            defaultStatus = preferenceTopicCreateRequest.defaultStatus
            name = preferenceTopicCreateRequest.name
            allowedPreferences =
                preferenceTopicCreateRequest.allowedPreferences.map { it.toMutableList() }
            includeUnsubscribeHeader = preferenceTopicCreateRequest.includeUnsubscribeHeader
            routingOptions = preferenceTopicCreateRequest.routingOptions.map { it.toMutableList() }
            topicData = preferenceTopicCreateRequest.topicData
            additionalProperties = preferenceTopicCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PreferenceTopicCreateRequest].
         *
         ...
         */
        fun build(): PreferenceTopicCreateRequest =
     ...
     *   expected type.
     */
    fun validate(): PreferenceTopicCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PreferenceTopicCreateRequest &&
    ...
    override fun toString() =
        "PreferenceTopicCreateRequest{defaultStatus=$defaultStatus, name=$name, allowedPreferences=$allowedPreferences, includeUnsubscribeHeader=$includeUnsubscribeHeader, routingOptions=$routingOptions, topicData=$topicData, additionalProperties=$additionalProperties}"
}
