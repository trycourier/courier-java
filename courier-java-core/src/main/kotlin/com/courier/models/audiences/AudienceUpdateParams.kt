...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun operator(): Optional<Operator> = body.operator()
    ...
    /** A builder for [AudienceUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audienceUpdateParams: AudienceUpdateParams) = apply {
            audienceId = audienceUpdateParams.audienceId
            body = audienceUpdateParams.body.toBuilder()
            additionalHeaders = audienceUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = audienceUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): AudienceUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AudienceUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(audienceId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "AudienceUpdateParams{audienceId=$audienceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
