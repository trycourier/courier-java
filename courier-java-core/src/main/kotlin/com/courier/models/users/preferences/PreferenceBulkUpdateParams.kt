...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PreferenceBulkUpdateParams].
         *
    ...
    /** A builder for [PreferenceBulkUpdateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * The topics to create or update. Between 1 and 50 topics may be provided in a single
         * request.
         */
        ...
        /**
         * Returns an immutable instance of [PreferenceBulkUpdateParams].
         *
         ...
         */
        fun build(): PreferenceBulkUpdateParams =
