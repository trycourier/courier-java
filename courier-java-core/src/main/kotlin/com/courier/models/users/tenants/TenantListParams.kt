...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tenantListParams: TenantListParams) = apply {
            userId = tenantListParams.userId
    ...
    override fun hashCode(): Int =
        Objects.hash(userId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TenantListParams{userId=$userId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
