...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun expiryDate(): Optional<ExpiryDate> = body.expiryDate()
     ...
     *   server responded with an unexpected value).
     */
    fun tracking(): Optional<Tracking> = body.tracking()
     ...
     */
    fun _providerKey(): JsonField<ProviderKey> = body._providerKey()
     ...
     */
    fun _device(): JsonField<Device> = body._device()
     ...
     */
    fun _expiryDate(): JsonField<ExpiryDate> = body._expiryDate()
     ...
     */
    fun _tracking(): JsonField<Tracking> = body._tracking()
    ...
    class Builder internal constructor() {
         ...
         * supported value.
         */
        fun expiryDate(expiryDate: JsonField<ExpiryDate>) = apply { body.expiryDate(expiryDate) }
         ...
         * value.
         */
        fun tracking(tracking: JsonField<Tracking>) = apply { body.tracking(tracking) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * supported value.
             */
            fun expiryDate(expiryDate: JsonField<ExpiryDate>) = apply {
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = expiryDate.accept(new ExpiryDate.Visitor<Optional<String>>() {
         *     @Override
