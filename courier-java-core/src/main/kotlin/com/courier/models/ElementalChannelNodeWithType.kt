...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(elementalChannelNodeWithType: ElementalChannelNodeWithType) = apply {
            ...
            elements = elementalChannelNodeWithType.elements.map { it.toMutableList() }
    ...
    override fun toString() =
        "ElementalChannelNodeWithType{channels=$channels, if_=$if_, loop=$loop, ref=$ref, channel=$channel, elements=$elements, fontSize=$fontSize, lineHeight=$lineHeight, padding=$padding, raw=$raw, type=$type, additionalProperties=$additionalProperties}"
}
