...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BrandListParams =
            BrandListParams(cursor, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "BrandListParams{cursor=$cursor, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
