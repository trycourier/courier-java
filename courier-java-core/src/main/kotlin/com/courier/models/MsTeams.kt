...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = msTeams.accept(new MsTeams.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitSendToMsTeamsUserId(SendToMsTeamsUserId sendToMsTeamsUserId) {
     *         return Optional.of(sendToMsTeamsUserId.toString());
     *     }
     *
     *     // ...
     *
