...
private constructor(
    ...
    ) : this(maxAllowed, period, scope, type, id, conditions, mutableMapOf())
    ...
    /** A builder for [JourneyThrottleStaticNode]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyThrottleStaticNode: JourneyThrottleStaticNode) = apply {
            maxAllowed = journeyThrottleStaticNode.maxAllowed
            period = journeyThrottleStaticNode.period
            scope = journeyThrottleStaticNode.scope
            type = journeyThrottleStaticNode.type
            id = journeyThrottleStaticNode.id
            conditions = journeyThrottleStaticNode.conditions
            additionalProperties = journeyThrottleStaticNode.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [JourneyThrottleStaticNode].
         *
         ...
         */
        fun build(): JourneyThrottleStaticNode =
     ...
     *   expected type.
     */
    fun validate(): JourneyThrottleStaticNode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyThrottleStaticNode &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(maxAllowed, period, scope, type, id, conditions, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "JourneyThrottleStaticNode{maxAllowed=$maxAllowed, period=$period, scope=$scope, type=$type, id=$id, conditions=$conditions, additionalProperties=$additionalProperties}"
}
