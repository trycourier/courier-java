...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JourneyRunListItem].
         *
    ...
    /** A builder for [JourneyRunListItem]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyRunListItem: JourneyRunListItem) = apply {
            runId = journeyRunListItem.runId
            source = journeyRunListItem.source.map { it.toMutableList() }
            createdAt = journeyRunListItem.createdAt
            status = journeyRunListItem.status
            templateId = journeyRunListItem.templateId
            additionalProperties = journeyRunListItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [JourneyRunListItem].
         *
     ...
     *   expected type.
     */
    fun validate(): JourneyRunListItem = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyRunListItem &&
            runId == other.runId &&
            source == other.source &&
    ...
    override fun toString() =
        "JourneyRunListItem{runId=$runId, source=$source, createdAt=$createdAt, status=$status, templateId=$templateId, additionalProperties=$additionalProperties}"
}
