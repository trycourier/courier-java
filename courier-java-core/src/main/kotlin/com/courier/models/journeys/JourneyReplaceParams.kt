...
private constructor(
    ...
    /** A builder for [JourneyReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyReplaceParams: JourneyReplaceParams) = apply {
            templateId = journeyReplaceParams.templateId
            createJourneyRequest = journeyReplaceParams.createJourneyRequest
            additionalHeaders = journeyReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = journeyReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [JourneyReplaceParams].
         *
         ...
         */
        fun build(): JourneyReplaceParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyReplaceParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(templateId, createJourneyRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "JourneyReplaceParams{templateId=$templateId, createJourneyRequest=$createJourneyRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
