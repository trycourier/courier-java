...
private constructor(
    ...
    /** A builder for [JourneyFetchPostPutNode]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyFetchPostPutNode: JourneyFetchPostPutNode) = apply {
            mergeStrategy = journeyFetchPostPutNode.mergeStrategy
            method = journeyFetchPostPutNode.method
            type = journeyFetchPostPutNode.type
            url = journeyFetchPostPutNode.url
            id = journeyFetchPostPutNode.id
            body = journeyFetchPostPutNode.body
            conditions = journeyFetchPostPutNode.conditions
            headers = journeyFetchPostPutNode.headers
            queryParams = journeyFetchPostPutNode.queryParams
            responseSchema = journeyFetchPostPutNode.responseSchema
        ...
        /**
         * Returns an immutable instance of [JourneyFetchPostPutNode].
         *
         ...
         */
        fun build(): JourneyFetchPostPutNode =
     ...
     *   expected type.
     */
    fun validate(): JourneyFetchPostPutNode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyFetchPostPutNode &&
    ...
    override fun toString() =
        "JourneyFetchPostPutNode{mergeStrategy=$mergeStrategy, method=$method, type=$type, url=$url, id=$id, body=$body, conditions=$conditions, headers=$headers, queryParams=$queryParams, responseSchema=$responseSchema, additionalProperties=$additionalProperties}"
}
