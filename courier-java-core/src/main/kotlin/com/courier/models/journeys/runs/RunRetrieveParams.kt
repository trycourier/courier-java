...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): RunRetrieveParams =
            RunRetrieveParams(runId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "RunRetrieveParams{runId=$runId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
