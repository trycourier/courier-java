...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateListParams: TemplateListParams) = apply {
            templateId = templateListParams.templateId
    ...
    override fun hashCode(): Int =
        Objects.hash(templateId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TemplateListParams{templateId=$templateId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
