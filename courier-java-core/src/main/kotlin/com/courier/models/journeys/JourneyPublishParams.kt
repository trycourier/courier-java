...
private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> =
        journeyPublishRequest?._additionalProperties() ?: immutableEmptyMap()
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [JourneyPublishParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [JourneyPublishParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [Builder.journeyPublishRequest] with
         * `journeyPublishRequest.orElse(null)`.
         */
        fun journeyPublishRequest(journeyPublishRequest: Optional<JourneyPublishRequest>) =
            journeyPublishRequest(journeyPublishRequest.getOrNull())
        ...
        /**
         * Returns an immutable instance of [JourneyPublishParams].
         *
    ...
    fun _body(): Optional<JourneyPublishRequest> = Optional.ofNullable(journeyPublishRequest)
