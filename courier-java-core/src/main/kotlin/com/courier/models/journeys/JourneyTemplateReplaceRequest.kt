...
private constructor(
    ...
    /** A builder for [JourneyTemplateReplaceRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyTemplateReplaceRequest: JourneyTemplateReplaceRequest) = apply {
            notification = journeyTemplateReplaceRequest.notification
            state = journeyTemplateReplaceRequest.state
            additionalProperties = journeyTemplateReplaceRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [JourneyTemplateReplaceRequest].
         *
         ...
         */
        fun build(): JourneyTemplateReplaceRequest =
            JourneyTemplateReplaceRequest(
     ...
     *   expected type.
     */
    fun validate(): JourneyTemplateReplaceRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyTemplateReplaceRequest &&
    ...
    override fun toString() =
        "JourneyTemplateReplaceRequest{notification=$notification, state=$state, additionalProperties=$additionalProperties}"
}
