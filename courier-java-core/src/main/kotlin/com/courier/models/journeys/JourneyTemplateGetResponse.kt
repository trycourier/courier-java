...
private constructor(
    ...
    /** A builder for [JourneyTemplateGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journeyTemplateGetResponse: JourneyTemplateGetResponse) = apply {
            id = journeyTemplateGetResponse.id
            brand = journeyTemplateGetResponse.brand
            content = journeyTemplateGetResponse.content
            created = journeyTemplateGetResponse.created
            creator = journeyTemplateGetResponse.creator
            name = journeyTemplateGetResponse.name
            state = journeyTemplateGetResponse.state
            subscription = journeyTemplateGetResponse.subscription
            tags = journeyTemplateGetResponse.tags.map { it.toMutableList() }
            updated = journeyTemplateGetResponse.updated
            updater = journeyTemplateGetResponse.updater
            additionalProperties = journeyTemplateGetResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): JourneyTemplateGetResponse =
     ...
     *   expected type.
     */
    fun validate(): JourneyTemplateGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JourneyTemplateGetResponse &&
            id == other.id &&
            brand == other.brand &&
    ...
    override fun toString() =
        "JourneyTemplateGetResponse{id=$id, brand=$brand, content=$content, created=$created, creator=$creator, name=$name, state=$state, subscription=$subscription, tags=$tags, updated=$updated, updater=$updater, additionalProperties=$additionalProperties}"
}
