...
import com.courier.services.blocking.providers.CatalogServiceImpl
...
class ProviderServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val catalog: CatalogService by lazy { CatalogServiceImpl(clientOptions) }
    ...
    override fun delete(params: ProviderDeleteParams, requestOptions: RequestOptions) {
        // delete /providers/{id}
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val catalog: CatalogService.WithRawResponse by lazy {
            CatalogServiceImpl.WithRawResponseImpl(clientOptions)
        }
