...
import com.courier.services.async.preferencesections.TopicServiceAsyncImpl
import java.util.concurrent.CompletableFuture
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class PreferenceSectionServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : PreferenceSectionServiceAsync {

    private val withRawResponse: PreferenceSectionServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val topics: TopicServiceAsync by lazy { TopicServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): PreferenceSectionServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): PreferenceSectionServiceAsync =
        PreferenceSectionServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            PreferenceSectionServiceAsyncImpl.WithRawResponseImpl(
