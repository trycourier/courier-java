...
[![Maven Central](https://img.shields.io/maven-central/v/com.courier/courier-java)](https://central.sonatype.com/artifact/com.courier/courier-java/4.20.0)
[![javadoc](https://javadoc.io/badge2/com.courier/courier-java/4.20.0/javadoc.svg)](https://javadoc.io/doc/com.courier/courier-java/4.20.0)
...
The REST API documentation can be found on [www.courier.com](https://www.courier.com/docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.courier/courier-java/4.20.0).
...
```kotlin
implementation("com.courier:courier-java:4.20.0")
```
