...
[![Maven Central](https://img.shields.io/maven-central/v/com.courier.api/courier-java)](https://central.sonatype.com/artifact/com.courier.api/courier-java/3.7.0-alpha0)
[![javadoc](https://javadoc.io/badge2/com.courier.api/courier-java/3.7.0-alpha0/javadoc.svg)](https://javadoc.io/doc/com.courier.api/courier-java/3.7.0-alpha0)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.courier.api/courier-java/3.7.0-alpha0).
...
```kotlin
implementation("com.courier.api:courier-java:3.7.0-alpha0")
```
