...
* **api:** give every request body an example, and correct the archive status code ([#132](https://github.com/trycourier/courier-java/issues/132)) ([0be2339](https://github.com/trycourier/courier-java/commit/0be2339be8e36965264ef0dca3a5a8cfc17df2cf))
